...
import notificationReducer from '../features/notification/notificationSlice'; // Import the notification slice reducer
...
const store = configureStore({
    reducer: {
        ...
        notification: notificationReducer, // Add the notification reducer under the 'notification' key
    },
});
